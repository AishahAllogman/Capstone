...
class CapstoneTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.movie = {"id": 101, "title": "Anne", "release_data": "5june2016"}
        self.updatemovie = {"title": "homealone", "release_data": "5june2016"}

        self.actor = {"id": 1, "name": "sara", "age": 30, "gender": "f"}
        self.updateactor = {"name": "abrar", "age": 20, "gender": "f"}
    ...
    def test_create_movies(self):
        res = self.client().post("/movies", headers, json=self.new_movie)
        data = json.loads(res.data)
        pass
    ...
    def test_create_actors(self):
        res = self.client().post("/actors", headers, json=self.new_actor)
        data = json.loads(res.data)
        pass

    def test_422_if_actors_creation_fails(self):
        res = self.client().post("/actors", headers, json=self.new_actors)
        data = json.loads(res.data)
        pass
    ...
    def test_update_movies(self):
        res = self.client().patch("/movies/1", headers, json=self.updatemovie)
        data = json.loads(res.data)
        pass

    def test_422_if_update_movies_fails(self):
        res = self.client().patch("/movies/30", headers, json=self.updatemovie)
        data = json.loads(res.data)
        pass
    ...
    def test_update_movies(self):
        res = self.client().patch("/actors/1", headers, json=self.updateactors)
        data = json.loads(res.data)
        pass

    def test_422_if_update_actors_fails(self):
        res = self.client().patch("/actors/9", headers, json=self.updateactors)
        data = json.loads(res.data)
        pass
